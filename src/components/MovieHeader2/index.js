      ...
      <div className={styles.container}>
        ...
        <div className={styles.section__tool}>
          ...
          <div className={styles.text}>
            라디오에 전화를 걸어 다리를 폭파하겠다는 익명의 협박이
            <br /> 실현된다. 좌천된 국민 앵커 윤영화는 일생일대의 기회를
            <br />
            생중계하고, 기회는 절체절명의 위기로 치닫는다.
          </div>
